...
const servers = {
  "https://mcp.asana.com/sse": {
    ...
    "requestInit": {
      "headers": {
        "Authorization": "Bearer 1201739145245840:Mm8Ypjy5AbwvQ6Cj:GhUimamDYlSk46h6ca4YQJhQjQp79D3S"
      }
    },
    "oauth": {
      "access_token": "1201739145245840:Mm8Ypjy5AbwvQ6Cj:GhUimamDYlSk46h6ca4YQJhQjQp79D3S",
      "token_type": "bearer",
      "expires_in": 3600,
      "scope": "",
      "refresh_token": "1201739145245840:Mm8Ypjy5AbwvQ6Cj:80qMB45IHgnksGonUVoT1wu69JqU7Pay"
    }
  },
  "everything": {
    "command": "npx",
  ...
  "linear": {
    ...
    "requestInit": {
      "headers": {
        "Authorization": "Bearer 553ad7de-32b5-4275-a303-ca9de7bfe5e4:9WZ3nqLjZVfi1CuS:kZGdw0cidKUWYRcOJFGSdySmzrdFzjX9"
      }
    },
    "oauth": {
      "access_token": "553ad7de-32b5-4275-a303-ca9de7bfe5e4:9WZ3nqLjZVfi1CuS:kZGdw0cidKUWYRcOJFGSdySmzrdFzjX9",
      "token_type": "bearer",
      "expires_in": 604800,
      "scope": "",
      "refresh_token": "553ad7de-32b5-4275-a303-ca9de7bfe5e4:9WZ3nqLjZVfi1CuS:zyxiR8INHr3jKRN2w62B5KXAonvpvJ7i"
    }
  }
} as const;
