...
Disabling a schedule is deliberately ungated everywhere: a gate that strands a schedule already firing, with no way to switch it off, is the worse failure.
