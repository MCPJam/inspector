 ...
 * `\` separators become `/`, `.` segments and empty segments collapse, and a
 * leading `./` is dropped. Rejects (never repairs) NUL bytes, control
 * characters, absolute paths, and `..` traversal.
 */
