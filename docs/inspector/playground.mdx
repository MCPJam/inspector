...
The picker opens on the tab that matches your currently selected model. When you search, results from both tabs appear together. A **"Catalog updated …"** line at the bottom of the free-models list shows when the hosted model catalog was last refreshed.
