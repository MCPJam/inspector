...
Loading a skill that an MCP server provided is a near miss and worth knowing: it is always TAGGED as third-party content and always bound to the manifest digest you were shown, but whether it pauses follows the switch.
