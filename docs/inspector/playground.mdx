...
If the out-of-credits dialog appears, clicking **Use your own API key** closes the dialog. In the Playground chat, it opens the model picker directly on the **Your providers** tab so you can switch to an own-key model without leaving the page. From other surfaces (eval generation, Markdown import, Ask MCPJam), it takes you to your organization's AI providers settings page where you can add a key.
