...
1. **Connect a server** — Add and connect an MCP server from the [Hosts](/inspector/hosts) tab (or the **+** button in the chat input).
...
- [Hosts](/inspector/hosts) — Manage MCP host configurations, server connections, and OAuth.
