...
The **Clear chat** button (next to the view tabs) clears the current conversation and starts a fresh session. You can also trigger it with the keyboard shortcut **⌘⇧K** (Mac) or **Ctrl+Shift+K** (Windows/Linux). A confirmation dialog appears before the conversation is removed.
