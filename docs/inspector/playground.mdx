...
<Note>
  Live sessions keep the most recent 200 turns in the Trace and Raw views. In
  sessions longer than 200 turns, the oldest turns are no longer shown. Saved
  sessions are also capped at 200 turns on reopen.
</Note>
