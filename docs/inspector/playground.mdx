...
- **Fill** (default) — The chat panel expands to fill the available panel space. No fixed frame is applied, matching how real hosts render chat.
- **Desktop** (1280×800)
- **Tablet** (820×1180)
- **Mobile** (430×932)
- **Custom** — Any width and height from 100 to 2560 pixels

Phone, tablet, desktop, and custom presets are opt-in emulation modes. Select them from the device picker in the toolbar when you want to test a widget inside a fixed-size frame.
