...
Edit the system prompt the model sees before your messages, and adjust the temperature slider (0 = deterministic, higher = more creative). The slider is disabled for models that do not accept a temperature value — for example, Claude Opus 4.7 and later, Sonnet 5, Fable 5, and Mythos 5.
