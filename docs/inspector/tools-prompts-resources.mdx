...
- **Trace context** - When a MCP 2026-07-28 server includes OpenTelemetry trace context in a result's `_meta`, the Response panel shows the trace id collapsed at the top of the result. Expand it to see the span id, sampling flag, and the raw `traceparent`, `tracestate`, and `baggage` header values.
