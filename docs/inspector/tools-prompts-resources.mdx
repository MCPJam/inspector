...
- **Elicitation support** - Handle elicitation requests from tools with a spec-complete form dialog (local inspector only)
...
- **Resource templates** - Test templated resources with dynamic parameters (local inspector only)
