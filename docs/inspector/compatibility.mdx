...
<Frame>
  <img className="block" src="/images/compat/compatibility-report.png" alt="The Compatibility page listing host rows with verdict badges and a conformance gate." />
</Frame>
