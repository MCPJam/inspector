...
Test Cases require a signed-in MCPJam account. If you open the Test Cases tab as a guest, you'll see a prompt to sign in rather than the testing interface.
