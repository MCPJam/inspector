...
| **Host management** | Creates hosts from a client template, opens a host's editor, attaches or detaches project servers on a host, duplicates, and deletes hosts on the Clients screen |
