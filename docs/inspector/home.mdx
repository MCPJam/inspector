...
When your daily MCPJam allowance or credit balance is exhausted, the panel shows the same out-of-credits modal that appears in the Playground — with **Upgrade** and **Buy credits** buttons. Once payment lands, the modal closes and the panel unlocks automatically. Models you access with your own API key (BYOK) are unaffected.
