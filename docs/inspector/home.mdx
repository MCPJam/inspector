...
The agent has access to your workspace data and can answer questions or take actions across several areas:

| Area | Example prompts |
|------|----------------|
| **Projects** | "List my projects", "What projects do I have?" |
| **MCP servers** | "List servers in my project", "Diagnose my weather server", "What tools does my server expose?" |
