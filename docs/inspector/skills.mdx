...
Once you send your message, the injected skill appears in the thread as a compact collapsible card showing the skill name and the number of attached files. Expand the card to see exactly what the model received. These cards have no edit action and are not included in the composer's Up/Down message history.
