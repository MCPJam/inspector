...
See [Playground → Logs tab](/inspector/playground/debug-compare#logs-tab) and [MCP Inspector](/inspector/tools-prompts-resources#json-rpc-logging) for how it surfaces in each tab.
