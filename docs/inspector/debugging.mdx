...
<Frame>
  <img className="block" src="/images/debugging/widget-debug-panel.png" alt="The Playground tool-call debug panel showing the Data tab for the reservation fixture widget." />
</Frame>
