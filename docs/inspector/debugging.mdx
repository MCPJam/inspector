...
When executing tools as background tasks, progress notifications appear in the logs panel. You can monitor:

- Task creation and status updates
- Progress notifications with completion percentages
- Elicitation requests for tasks requiring input
- Task completion or failure events

See the [Tasks tab](/inspector/tasks) for a dedicated task monitoring interface.
