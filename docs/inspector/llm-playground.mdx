---
title: "Chat"
description: "Chat with your MCP server against any LLM"
icon: "message-circle"
---

The Chat tab lets you chat with your MCP server using any LLM. Test how different models interact with your tools, simulate agent behaviors, and render supported ChatGPT apps and MCP apps inline in the conversation. We provide frontier models like GPT-5 and Claude Sonnet for free, or bring your own API key.
...
To use Chat, configure at least one LLM provider:
...
4. **Select Model** - Go to the Chat tab and choose your model from the dropdown
...
Use MCP prompts directly in chat by typing `/` to trigger the prompts menu. When you select a prompt, it appears as an expandable card showing:
