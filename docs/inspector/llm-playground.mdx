...
You can use the playground with free MCPJam-provided models (no API key required) or configure your own LLM providers. Go to the settings tab in the inspector to configure API keys.

### Free models (no API key required)

MCPJam provides free access to select models. Simply select one from the model dropdown:
...
<Note>
  Free models require authentication. Sign in to use these models.
</Note>
