...
If you're running MCPJam locally, the endpoint URLs point at your own machine. Your authorization server can only reach them if it can route to that machine — expose MCPJam through a public tunnel first.
