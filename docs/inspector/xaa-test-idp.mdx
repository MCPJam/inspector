...
Open the **XAA Flow** tab in MCPJam Inspector. At the top of the tab, find the **Use MCPJam as your test IdP** section. It lists three copy-able URLs and the active signing key id (`kid`).
