...
Open the **XAA Flow** tab in MCPJam Inspector. At the top of the tab, the **Use MCPJam as your test IdP** card shows three click-to-copy chips — **Issuer URL**, **OpenID Config**, and **JWKS URL** — alongside the active signing key id (`kid`). Hover a chip to see the full URL; click it to copy.
