...
<Frame>
  <img className="block" src="/images/compat/compat-strip.png" alt="The Servers view showing a server card with the host-compat strip, including host logos and status dots." />
</Frame>
