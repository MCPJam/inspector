...
|------------|--------|------------|
| Vendor doc | Published capability table (e.g. Microsoft's Copilot 1.0.1 MCP Apps table) | High |
| Probe | Captured from a live client session (e.g. VS Code 1.130, Cursor) | High, but versioned |
