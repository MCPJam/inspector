...
- **MCP Apps** (`_meta.ui.resourceUri`) — rendered by Claude, ChatGPT, Cursor, Copilot, and Codex. Codex runs the same ChatGPT app runtime, confirmed by a probe on 2026-08-19.
