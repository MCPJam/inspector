...
A **Run as** person selected in the chip strip above takes precedence over
these fields. The per-server identity takes precedence over the global
run-settings default. See [Run as a Test Identity](#run-as-a-test-identity)
