...
- **Okta** - Native jwt-bearer support. Register MCPJam as a trusted identity issuer using the JWKS URL from the **Use MCPJam as your test IdP** card at the top of the XAA Flow tab.
...
- Use the [**Use MCPJam as your test IdP** card](/inspector/xaa-test-idp) on the XAA Flow tab to get the issuer and JWKS URLs for configuring issuer trust
