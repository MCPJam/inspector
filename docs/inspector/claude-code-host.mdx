---
title: "Claude Code host"
description: "Run the real Claude Code agent inside your project's Computer — observe its native tools, MCP client, and execution behavior directly"
icon: "terminal"
---
