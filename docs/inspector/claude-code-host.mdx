...
| Your platform cannot prove whole-tree cleanup | Native is not offered, and says why: MCPJam could not guarantee that stopping a session stops everything it started. |
