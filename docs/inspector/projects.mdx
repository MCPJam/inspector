...
Click the switcher at the top of the sidebar to open the context menu.
</Step>

<Step title="Create a project">
Click the **+** icon next to the **Projects** heading and give it a name.
</Step>

<Step title="Add your servers">
Configure your MCP servers in the Connect tab.
</Step>

<Step title="Enable auto-connect">
Use the **Auto-connect** toggle in the Connect tab header to automatically connect all project servers whenever a host opens.

<Check>
Your servers connect on their own the next time a host opens, so you can go straight to the Playground.
</Check>
</Step>

<Step title="Share with your team">
Click the share button and invite collaborators. The full flow is under [Sharing Projects](#sharing-projects).
</Step>
</Steps>
