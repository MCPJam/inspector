...
<Note>
If you are browsing as a guest on the hosted app, the **Invite team members** button is still visible in the sidebar. Clicking it opens a prompt to create a free account or sign in. After you complete sign-up or sign in, the invite dialog opens automatically so you can continue where you left off.
</Note>
