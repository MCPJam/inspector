...
- **OpenAI submission report** — for runs that pinned a plugin, a **Submission report** button in the run header downloads a Markdown document formatted for OpenAI's plugin directory review. See [OpenAI submission report](/inspector/evals#openai-submission-report).
