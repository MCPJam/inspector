...
<Note>
Plugins are available to all users — including guests — on accounts where the feature has been enabled. The **Add plugin** entry and the Plugins section only appear when the feature is active for your account.
</Note>
