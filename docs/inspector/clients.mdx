...
<Frame>
  <img className="block" src="/images/clients/client-focus-panel.png" alt="The Hosts focus panel opened from a template deep link, showing the canvas diagram and settings." />
</Frame>
...
<Frame>
  <img className="block" src="/images/clients/host-compare-view.png" alt="The Compare view with two host columns shown side by side." />
</Frame>
