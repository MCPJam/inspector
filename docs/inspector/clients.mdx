...
While the Connect canvas is open, a **client selector** appears in the canvas header's left column — on the same row as the **Servers | Client** view selector. It shows two controls:
