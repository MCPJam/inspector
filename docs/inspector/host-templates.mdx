...
<Tip>
  ...
  n8n MCP Client Tool, Perplexity), replace `clientCapabilities` instead of
  spreading — a spread leaks the SDK-default MCP UI extension back in and
  misrepresents the host as UI-capable. See the Codex, n8n, or Perplexity
  presets for the pattern.
</Tip>
