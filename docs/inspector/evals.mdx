...
If your daily MCPJam allowance or credit balance is exhausted when generation starts, the out-of-credits modal appears with **Upgrade** and **Buy credits** options — the same modal shown in the Playground and Ask MCPJam panel. Once payment lands the modal closes and you can generate again. Models you access with your own API key (BYOK) are unaffected.
