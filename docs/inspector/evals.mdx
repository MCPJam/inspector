...
- **Server quality** — after a run completes, a **Server quality** card analyzes tool-quality and workflow issues for the connected server. Guests browsing without a signed-in account will see a **Sign in to analyze** prompt on this card — signing in unlocks the analysis without losing your place.
