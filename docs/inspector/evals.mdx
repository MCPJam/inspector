...
<Frame>
  <img className="block" src="/images/evals/evals-suite-dashboard.png" alt="The Evals suite view showing accuracy, runs, and cases." />
</Frame>
...
<Frame>
  <img className="block" src="/images/evals/evals-run-detail.png" alt="An Evals run detail view displaying the run header with a PASSED badge, pass-rate statistics, AI-generated run insights, per-case results, and previous runs in a side rail." />
</Frame>
