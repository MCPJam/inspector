...
**From User Testing** — Open a study's **Sessions** tab, select a session, and click **Promote to test case**. After the case is created, you land on the suite's case list rather than the case editor.
