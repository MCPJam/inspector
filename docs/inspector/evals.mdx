...
Suite and run URLs are shareable. When you paste a link in Slack, a PR description, or anywhere else, the recipient lands on the correct project automatically — the app reads the `?project=` parameter embedded in the URL and switches their active project to match before showing the results. If the recipient doesn't have access to that project, they see a toast and stay on their current project.
