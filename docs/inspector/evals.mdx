...
A row's **role** says what a miss does: **Required** fails the trial, **Advisory** shows the miss without failing it. The control appears when your deployment supports check policy; otherwise the role still shows, read-only.
