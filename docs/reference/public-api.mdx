...
| `INTERNAL_ERROR` | 500 | Something failed on our side — `details.requestId` carries a reference id that matches the `x-request-id` response header; include it when contacting support |
