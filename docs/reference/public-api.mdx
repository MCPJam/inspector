...
`POST /projects/{projectId}/servers/{serverId}/...`. Each one is fully
documented — request and response schemas, examples, and an interactive
playground — under **Endpoints** in the sidebar.
