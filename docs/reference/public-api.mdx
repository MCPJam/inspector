...
| `POST .../user-testing/scenarios/{scenarioId}/insights` | **No credits; counts against `insightsPerDay`.** `202` with the `windowId` to poll. `409` if the window has not been mined yet |
