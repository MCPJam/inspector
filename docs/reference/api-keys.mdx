...
**Expiry:** New keys expire after **90 days** by default. When creating a key you can choose any expiry from 7 days to 1 year. Keys created before this change keep working until they are revoked.
...
**Organization key management:** Organization owners and admins can view and revoke any API key bound to their organization from **Organization keys** in Settings. The list shows each key's expiry, including keys whose owner's account was removed. Owners and admins can also control whether members may create keys at all.
