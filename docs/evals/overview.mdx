...
<Note>
**Licensing**: The evals functionality is licensed under the MCPJam Enterprise Edition (EE) license for production use. You may use it for development and testing purposes without a subscription. See the [LICENSE](https://github.com/MCPJam/inspector/blob/main/LICENSE) for details.
</Note>
