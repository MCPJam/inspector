...
<CardGroup cols={3}>
  ...
  <Card title="Desktop App" icon="monitor">
    Download for [Mac](https://github.com/MCPJam/inspector/releases/v2.2.0/download/MCPJam.Inspector.dmg) or [Windows](https://github.com/MCPJam/inspector/releases/v2.2.0/download/MCPJam-Inspector-Setup.exe). HTTP/S and local STDIO.
  </Card>
...
- [Mac](https://github.com/MCPJam/inspector/releases/v2.2.0/download/MCPJam.Inspector.dmg)
- [Windows](https://github.com/MCPJam/inspector/releases/v2.2.0/download/MCPJam-Inspector-Setup.exe)
