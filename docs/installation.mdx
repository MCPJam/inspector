...
<Info>
The Docker image uses a multi-stage build process optimized for production deployment, matching the build process used in GitHub Actions. This ensures consistent behavior across environments.
</Info>
