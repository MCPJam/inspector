...
```bash
# Custom port
docker run -p 4000:4000 mcpjam/mcp-inspector --port 4000

# Verbose logging
docker run -p 6274:6274 mcpjam/mcp-inspector --verbose

# Multiple arguments
docker run -p 4000:4000 mcpjam/mcp-inspector --port 4000 --verbose
```
