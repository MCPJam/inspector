...
- **OAuth Debugger**
  - Enhanced SSE (Server-Sent Events) response handling
  - Better detection of legacy HTTP+SSE transport (2024-11-05)
  - Improved error messages for SSE parsing failures
  - Updated client name to "MCPJam Inspector" across all protocols
