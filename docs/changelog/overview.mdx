...
- **Findings summary renders as one paragraph** — the Finding summary card on the swarm run's Findings tab and the User Testing study's Findings tab now displays its summary as a single flowing paragraph instead of a headline with stacked supporting lines beneath it.
