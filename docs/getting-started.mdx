...
<AccordionGroup>
  ...
  <Accordion title="Where are my files saved?" icon="folder">
    ...
    - **Eval results**: previously uploaded to your MCPJam workspace via `MCPJAM_API_KEY` — now retired; results stay local. See [Saving Results](/sdk/concepts/saving-results).
