...
Press **Send**. The diagram renders in the app. No API key, ngrok, or paid subscription. Sequence: tool call → widget → inspect.
...
<CardGroup cols={2}>
  ...
  <Card title="Workspaces" icon="folder" href="/inspector/workspaces">
