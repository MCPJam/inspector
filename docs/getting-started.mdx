...
Press **Send**. The diagram renders in the app: tool call, then widget, then inspect. No API key, ngrok, or ChatGPT/Claude subscription needed.

<Frame>
  <img className="block" src="/images/getting-started/getting-started-first-diagram.png" alt="The Playground showing the Excalidraw sample, with the create_view tool call and the rendered diagram." />
</Frame>
