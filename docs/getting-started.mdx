...
Once you hit submit, you should see the connection status as "Connected". This page is your server connections page. You can connect to multiple MCP servers simultaneously on MCPJam and organize them into workspaces.
