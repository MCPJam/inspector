...
On first launch MCPJam shows a server-connection overlay. Open the **Servers** tab and add your own server, then head to the **Playground** to render widgets, debug CSP/device behavior, and drive your app with an LLM.
