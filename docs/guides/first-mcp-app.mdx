...
On first launch MCPJam auto-connects a sample Excalidraw server — open the **Servers** tab and add your own. Then head to the **App Builder** tab (for widget rendering and CSP/device debugging) or the **Chat** tab (to drive it with an LLM) and test your app!
