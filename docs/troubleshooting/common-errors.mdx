...
If all five check out and you still see a failure, click **Copy** on the error card to copy the full error — title, likely causes, next steps, and raw details — then paste it into a [GitHub issue](https://github.com/MCPJam/inspector/issues) or [Discord](https://discord.gg/JEnDtz8X6z) thread.
