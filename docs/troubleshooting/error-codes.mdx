...
This error alone does not identify whether MCPJam or your own model key was used.
The run's execution-error card uses the recorded model source to provide that context.
