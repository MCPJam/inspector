...
<Tabs>
  <Tab title="MCP Routes">
    ...
    │   └── /tasks
    │       ├── POST /list - List tasks
    │       ├── POST /get - Get task status
    │       ├── POST /result - Get task result
    │       ├── POST /cancel - Cancel task
    │       ├── POST /capabilities - Get task capabilities
    │       └── POST /progress - Get task progress
    ├── /openai
  ...
  <Tab title="File Locations">
    ...
    | `/tasks` | `server/routes/mcp/tasks.ts` | - |
