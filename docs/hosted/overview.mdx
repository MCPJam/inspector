...
If a subscription payment fails, your organization keeps its current plan and credits for a **7-day grace period** while Stripe retries the charge and sends you an email to update your card.

During the grace period, org owners see a **"Payment failed — update your card"** banner at the top of the org billing page. Click **Update payment method** in the banner to open the Stripe billing portal and fix your card details.

If the payment isn't resolved within 7 days, the subscription is cancelled and the organization is moved to the Free plan (credits are cleared).

### Seat changes

Adding or removing seats takes effect immediately and is billed in the current billing cycle:

- **Adding a seat** — you are charged a prorated amount for the remainder of the current cycle right away.
- **Removing a seat** — the unused portion of the seat's cost becomes account credit applied toward your next invoice.
