...
| `--protocol-version <version>` | No | legacy (2025-era) | Pin the MCP protocol era to conform against (e.g. `2026-07-28`). Unknown or whitespace-only values are rejected as usage errors. |
| `--reporter <reporter>` | No | | `json-summary` or `junit-xml` CI report output |
