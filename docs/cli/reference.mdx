...
| `--ui` | Attach to Inspector and render the completed tool result in App Builder; opens a browser by default |
| `--open` | Open Inspector in the system browser before rendering (default with `--ui`) |
