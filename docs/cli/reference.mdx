...
## `cloud eval` commands (quick reference)
...
### `cloud eval create` (quick reference)
...
### `cloud eval list` (quick reference)
...
### `cloud eval run` (quick reference)
...
### `cloud eval status` (quick reference)
