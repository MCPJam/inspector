...
| [`eval`](/cli/reference#eval-commands) | Author and run eval suites in your hosted MCPJam projects | `create`, `list`, `run`, `status`, `iterations`, `trace`, `screenshot`, `get`, `update`, `delete`, `schedule`, `cases` |
