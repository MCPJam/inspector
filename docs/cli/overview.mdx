...
| [`readiness`](/cli/readiness-check) | Grade a connector or plugin locally against Anthropic's and OpenAI's directory requirements (free, no account needed) | `check claude`, `check openai` |
