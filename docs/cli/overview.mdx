...
The easiest way to use the CLI is through the [MCPJam skill](https://github.com/MCPJam/skills/tree/main/skills/mcp-inspector/references), which gives your agent full context on every command and workflow.

```bash
npx skills add mcpjam/skills
```
