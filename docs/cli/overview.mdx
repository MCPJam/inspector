...
| [`env`](/cli/reference#env-commands) | List, build, and manage custom Computer environments (Dockerfile images) in your hosted projects | `list`, `get`, `create`, `edit`, `build`, `logs`, `use`, `reset`, `promote`, `delete` |
