...
<Frame>
  <img className="block" src="/images/cli/cli-help.png" alt="Terminal output of mcpjam --help." />
</Frame>
...
| [`env`](/cli/reference#env-commands) | Manage custom computer environments (Dockerfile images) | `list`, `get`, `create`, `edit`, `build`, `logs`, `use`, `reset`, `promote`, `delete` |
