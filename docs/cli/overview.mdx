...
| [`projects`](/cli/reference#projects-commands) | Manage projects and their saved servers | `list`, `create`, `update`, `delete`, `status`, `server connect`, `server connect-status` |
