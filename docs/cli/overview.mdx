...
| [`compat`](/cli/host-compatibility) | Check whether a server's tools and widgets work on each AI host | `compat` |
...
- [Host compatibility](/cli/host-compatibility) — check whether your server works on Claude, ChatGPT, Cursor, and other AI hosts
