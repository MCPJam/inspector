...
<Frame>
  <img className="block" src="/images/cli/cli-apps-conformance.png" alt="Terminal output of mcpjam apps conformance running against the reservation fixture server." />
</Frame>
