...
After running evals, you can save results to MCPJam to track accuracy over time, compare across branches, and review them in the **Runs** mode of the Evaluate surface (`/evals/runs`).

<Frame caption="Runs mode showing eval suite accuracy, pass rate trends, per-model performance, and more">
  <img src="/images/ci-runs-overview.png" alt="Runs mode overview" />
</Frame>
