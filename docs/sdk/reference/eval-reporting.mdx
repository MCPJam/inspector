---
title: "Eval Reporting"
description: "API reference for reporting eval results to MCPJam"
icon: "book"
---

The SDK provides reporting APIs to send eval results to MCPJam for visualization in the CI Evals dashboard. Results can be reported automatically via `EvalTest`/`EvalSuite`, or manually using the APIs below.
...
| `MCPJAM_BASE_URL` | No | `https://api.mcpjam.com` | MCPJam API base URL |
...
| `baseUrl` | `string` | No | MCPJam API base URL |
