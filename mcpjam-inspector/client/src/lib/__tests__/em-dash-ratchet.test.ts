...
const LEGACY_EM_DASH_COPY = new Map<string, number>([
  ...
  ["components/chat-v2/shared/chat-helpers.ts", 1],
  ...
  ["components/project-environments/ProjectEnvironmentEditor.tsx", 5],
  ...
  ["components/shared/usage-insights/ClusterTuningControl.tsx", 2],
  ["components/shared/usage-insights/ExplanatoryFlowOptIn.tsx", 1],
  ["components/shared/usage-insights/rebuild-feedback.ts", 1],
  ["components/shared/usage-insights/run-insights.tsx", 4],
  ["components/shared/usage-insights/SessionFlowSankey.tsx", 4],
  ...
  ["components/swarms/findings/findings-headline.ts", 5],
  ["components/swarms/journey-list.tsx", 3],
  ["components/swarms/journey-rubric-editor.tsx", 2],
  ...
  ["components/swarms/new-swarm-running-step.tsx", 3],
  ["components/swarms/run-scorecard.tsx", 1],
  ["components/swarms/swarm-run-detail.tsx", 4],
  ...
  ["components/xaa/XAAServerModal.tsx", 1],
  ["hooks/use-chat-session.ts", 5],
  ["hooks/use-run-cost-estimate.ts", 4],
  ["hooks/use-run-insights.ts", 1],
  ["hooks/useComputerAttachmentUpload.ts", 1],
  ...
  ["lib/cluster-tuning.ts", 1],
  ["lib/computer-attachments.ts", 1],
  ["lib/environment-error.ts", 3],
  ...
  ["lib/github-checks-errors.ts", 5],
  ["lib/learn-more-content.ts", 2],
  ["lib/oauth/mcp-oauth.ts", 4],
