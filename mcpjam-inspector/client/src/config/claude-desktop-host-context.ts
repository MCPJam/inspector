...
const CLAUDE_DESKTOP_LIGHT_DARK_VARS: Record<string, [light: string, dark: string]> = {
  ...
  "--color-background-inverse": ["rgba(20, 20, 19, 1)", "rgba(250, 249, 245, 1)"],
  "--color-background-ghost": ["rgba(255, 255, 255, 0)", "rgba(48, 48, 46, 0)"],
  "--color-background-info": ["rgba(214, 228, 246, 1)", "rgba(37, 62, 95, 1)"],
  "--color-background-danger": ["rgba(247, 236, 236, 1)", "rgba(96, 42, 40, 1)"],
  "--color-background-success": ["rgba(233, 241, 220, 1)", "rgba(27, 70, 20, 1)"],
  "--color-background-warning": ["rgba(246, 238, 223, 1)", "rgba(72, 58, 15, 1)"],
  "--color-background-disabled": ["rgba(255, 255, 255, 0.5)", "rgba(48, 48, 46, 0.5)"],
  ...
  "--color-text-ghost": ["rgba(115, 114, 108, 0.5)", "rgba(156, 154, 146, 0.5)"],
  ...
  "--color-text-disabled": ["rgba(20, 20, 19, 0.5)", "rgba(250, 249, 245, 0.5)"],
  "--color-border-primary": ["rgba(31, 30, 29, 0.4)", "rgba(222, 220, 209, 0.4)"],
  "--color-border-secondary": ["rgba(31, 30, 29, 0.3)", "rgba(222, 220, 209, 0.3)"],
  "--color-border-tertiary": ["rgba(31, 30, 29, 0.15)", "rgba(222, 220, 209, 0.15)"],
  "--color-border-inverse": ["rgba(255, 255, 255, 0.3)", "rgba(20, 20, 19, 0.15)"],
  ...
  "--color-border-disabled": ["rgba(31, 30, 29, 0.1)", "rgba(222, 220, 209, 0.1)"],
  "--color-ring-primary": ["rgba(20, 20, 19, 0.7)", "rgba(250, 249, 245, 0.7)"],
  "--color-ring-secondary": ["rgba(61, 61, 58, 0.7)", "rgba(194, 192, 182, 0.7)"],
 ...
 * for the given theme.
 */
export function getClaudeDesktopStyleVariables(theme: "light" | "dark"): McpUiStyles {
  const idx = theme === "light" ? 0 : 1;
  const resolved: Record<string, string> = {};
  for (const [key, [light, dark]] of Object.entries(CLAUDE_DESKTOP_LIGHT_DARK_VARS)) {
