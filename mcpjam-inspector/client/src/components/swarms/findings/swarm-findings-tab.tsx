 ...
 * the detail page already holds (`deriveSwarmFindingsModel`). Given
 * `onOpenSession`, each evidence row lists the sessions IT implicates — the
 * scope travels on the evidence, never on the goal.
 *
