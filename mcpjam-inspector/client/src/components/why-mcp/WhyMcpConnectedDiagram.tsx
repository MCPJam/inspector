...
import { springGentle, springSnappy, useDiagramMotion, VIEWPORT_ONCE } from "./diagram-motion";
  ...
  return (
    ...
    >
      <motion.div
        ...
        transition={
          reduce ? { duration: 0 } : { duration: 3.6, repeat: Infinity, ease: "easeInOut", delay: delay * 2 }
        }
      ...
      <div className="relative h-1 w-full max-w-[4rem] overflow-hidden rounded-full bg-blue-500/15 dark:bg-blue-400/20 sm:max-w-[5rem]">
        <motion.div
          ...
          transition={
            reduce
              ? { duration: 0 }
              : { duration: 1.8, repeat: Infinity, ease: "linear", repeatDelay: 0.5, delay }
          }
        />
      </div>
    </div>
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-blue-200/45 bg-gradient-to-b from-blue-50/80 to-card shadow-sm dark:border-blue-900/40 dark:from-blue-950/25 dark:to-card">
      ...
      >
        ...
        <motion.div className="flex min-w-0 flex-1 justify-center" variants={wireVariants}>
          <LiveWire delay={0} flip />
        </motion.div>

        <motion.div className="relative z-10 shrink-0" variants={centerVariants}>
          <motion.div
        ...
        <motion.div className="flex flex-col gap-4" variants={sideRightVariants}>
