...
describe("ScenarioPreviewPane", () => {
  it("tags the embedded run as preview traffic", () => {
    render(
      <ScenarioPreviewPane publishLink={sameOriginLink} mcpProfile={undefined} />,
    );
  ...
  it("emits an empty allow for a deny-all host", () => {
    ...
    render(
      <ScenarioPreviewPane publishLink={sameOriginLink} mcpProfile={profile} />,
    );
  ...
  it("shows the empty state, and no frame, without a share link", () => {
    render(<ScenarioPreviewPane publishLink={null} mcpProfile={undefined} />);
   ...
   */
  it("hands off to a browser tab when the frame navigates off the scenario", () => {
    render(
      <ScenarioPreviewPane publishLink={sameOriginLink} mcpProfile={undefined} />,
    );
    ...
    // parked somewhere that isn't the scenario runtime path.
  ...
  it("keeps the frame when a load lands back on the scenario path", () => {
    render(
      <ScenarioPreviewPane publishLink={sameOriginLink} mcpProfile={undefined} />,
    );
