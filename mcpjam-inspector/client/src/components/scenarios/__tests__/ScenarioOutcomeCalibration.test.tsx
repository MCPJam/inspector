...
import { ScenarioOutcomeCalibration } from "../ScenarioOutcomeCalibration";
import type {
...
describe("ScenarioOutcomeCalibration", () => {
  it("renders nothing when the server sent no calibration rows", () => {
    const { container } = render(
      <ScenarioOutcomeCalibration breakdown={breakdown()} />
    );
