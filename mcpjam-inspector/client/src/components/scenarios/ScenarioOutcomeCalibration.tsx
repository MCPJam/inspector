 ...
 */
interface ScenarioOutcomeCalibrationProps {
...
export function ScenarioOutcomeCalibration({
  breakdown,
}: ScenarioOutcomeCalibrationProps) {
  ...
  return (
    <div
      ...
      data-testid="scenario-outcome-calibration"
    >
