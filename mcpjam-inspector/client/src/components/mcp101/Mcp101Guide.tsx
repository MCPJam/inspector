...
function StepSection({
  ...
  const guide: Mcp101StepGuide = MCP101_GUIDE_METADATA[stepId];
  const phaseColor =
    MCP101_PHASE_ACCENT[guide.phase as keyof typeof MCP101_PHASE_ACCENT] ??
    "#94a3b8";
  ...
  return (
    ...
    >
      ...
      <div className="px-8 pt-8 pb-4">
        ...
        >
          ...
          <p className="text-sm text-muted-foreground leading-relaxed max-w-prose">
            A bird&apos;s-eye introduction to the Model Context Protocol — what
            it is, why it exists, and how it gives AI agents the ability to
      ...
      <div className="px-8 pb-16">
        {MCP101_STEP_ORDER.map((stepId, index) => (
          <StepSection
            key={stepId}
            stepId={stepId}
            index={index}
        ...
        >
          <p className="text-sm text-muted-foreground/60">
            That&apos;s the big picture. Explore the MCP Lifecycle card to see
