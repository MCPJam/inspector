    ...
    <section className="space-y-8">
      <header className="space-y-2">
        ...
        <SettingsPageDescription>
          Manage your organization’s data retention requirements across
          projects.
        </SettingsPageDescription>
      </header>
      <div className="flex min-h-56 flex-col items-center justify-center gap-5 rounded-lg border border-border bg-muted/20 p-6 text-center">
        ...
        <p className="text-muted-foreground">
          {enterprise
            ? "Contact us to configure your organization’s retention policy."
            : "Custom data retention is available with Enterprise."}
        </p>
        <Button asChild>
...
export function PermissionGroupsDialog({
  enterprise,
}: {
  enterprise: boolean;
}) {
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Talk with us about your organization’s access-control requirements
            and a tailored Enterprise setup.
          </DialogDescription>
        </DialogHeader>
        <div className="grid gap-4 py-4 sm:grid-cols-2">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Discuss roles and access policies for your teams.
            </p>
          </div>
          <div>
            <LockKeyhole
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Plan your security and data-management requirements with us.
            </p>
          </div>
        </div>
        <DialogFooter>
