...
vi.mock("../../settings/SettingsDraftProvider", () => ({
...
it("saves the edited fields together", async () => {
  ...
  await userEvent.type(screen.getByLabelText("Project name"), "New name");
  await userEvent.click(screen.getByRole("button", { name: "Save changes" }));
  expect(save).toHaveBeenCalledWith({ name: "New name", description: "Old" });
});
