...
export const APP_SURFACES = [
  ...
  },
  {
    ...
    routePatterns: ["user-testing", "user-testing/new"],
    navSegments: ["chatboxes"],
    title: "User Testing",
    purpose:
      "Create shareable user tests against a host and server, then review real tester sessions.",
    userActivities: [
      "Create a new user test (pick server, client, and who can take it)",
      "Open a test's share link and invite testers",
      "Review sessions for a test (trace, chat, raw)",
      "Browse feedback clusters across tests",
    ],
    hasSnapshotProvider: true,
    agentTools: { kind: "group" },
    showInAtlas: true,
