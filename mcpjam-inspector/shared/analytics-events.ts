...
export const ANALYTICS_EVENTS = {
  ...
  first_run_authorize_clicked: { source: "client" },
  first_run_connect_failed: { source: "client" },
  first_run_connect_started: { source: "client" },
  first_run_connect_succeeded: { source: "client" },
  first_run_input_rejected: { source: "client" },
