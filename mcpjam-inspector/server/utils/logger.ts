...
export const logger = {
   ...
   * @deprecated For new production diagnostics in route handlers use `logger.event()` instead.
   * Free-form messages are not queryable in Axiom. See `server/utils/LOGGING.md`.
   */
