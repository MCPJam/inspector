...
try {
  const result = await build({
    entryPoints: [
      join(__dirname, "../server/routes/mcp/McpAppsOpenAICompatibleRuntime.ts"),
    ],
    bundle: true,
    write: false,
    format: "iife",
...
// Do not edit directly - modify server/routes/mcp/McpAppsOpenAICompatibleRuntime.ts instead
...
`;
  ...
  const outputTsPath = join(
    __dirname,
    "../server/routes/mcp/McpAppsOpenAICompatibleRuntime.bundled.ts",
  );
